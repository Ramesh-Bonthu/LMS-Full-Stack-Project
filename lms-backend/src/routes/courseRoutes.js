...
router.post("/", verifyToken, requireRole("FACULTY", "ADMIN"), upload.single("pdf"), courseController.createCourse);
router.put("/:id", verifyToken, requireRole("FACULTY", "ADMIN"), upload.single("pdf"), courseController.updateCourse);
